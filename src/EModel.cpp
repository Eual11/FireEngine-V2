...
/**/
/*   try { */
/*     add(ProcessNode(glm::mat4(1.0f), scene->mRootNode, scene)); */
/*   } catch (std::bad_weak_ptr &) { */
/*     printf("BAD PTR\n!!!"); */
/*   } */
/* } */
/* std::shared_ptr<EObject3D> EModel::ProcessNode(glm::mat4 m, aiNode *node, */
/*                                                const aiScene *scene) { */
/**/
...
/*     if (currentNode) { */
/**/
/*       auto nMesh = ProcessMesh(m, scene->mMeshes[node->mMeshes[i]],
   scene); */
...
/*   return currentNode; */
/* } */
/* std::shared_ptr<EMesh> EModel::ProcessMesh(glm::mat4 &m, aiMesh *mesh, */
/*                                            const aiScene *scene) { */
/**/
...
/*       v.TexCoord = {0, 0}; */
/*     if (mesh->HasNormals()) { */
/*       v.Normal = glm::mat3(glm::transpose(glm::inverse(m_ive))) *v.Normal
   = */
...
/**/
/*     // TODO: IMPLEMENT A WAY TO SELECT A MATERIAL BASED ON THE SHADING
   MODEL */
/*     // USED */
/*     auto phongMeshMaterial =
   std::make_shared<PhongMaterial>(PhongMaterial()); */
/**/
/*     float val = 0.0f; */
/*     aiColor3D color; */
...
/*       phongMeshMaterial->diffuse_color = glm::vec3(color.r, color.g,
   color.b); */
/*     } */
/*     if (mat->Get(AI_MATKEY_COLOR_AMBIENT, color) == AI_SUCCESS) { */
/*       phongMeshMaterial->ambient_color = glm::vec3(color.r, color.g,
   color.b); */
/*     } */
/**/
/*     if (mat->Get(AI_MATKEY_COLOR_SPECULAR, color) == AI_SUCCESS) { */
/*       phongMeshMaterial->specular_color = glm::vec3(color.r, color.g,
   color.b); */
/*     } */
...
/**/
/*   } else { */
/*     fprintf(stderr, "Filename %s doesn't exist, Loading Default
   Textures\n", */
/*             filename.c_str()); */
/*     filename =
