...
int main() {
  ...
  Shader shaderProgram("../shaders/vertex/materialVert.glsl",
                       "../shaders/fragment/materialFrag.glsl");
  ...
  shaderProgram.setVec3("material.specular", glm::vec3(0.5f, 0.5f, 0.50f));
  ...
  while (!glfwWindowShouldClose(gWindow)) {
    ...
    glm::vec3 lightColor =
        glm::vec3(sin(glfwGetTime() * 2.3f), sin(glfwGetTime() * 0.37f),
